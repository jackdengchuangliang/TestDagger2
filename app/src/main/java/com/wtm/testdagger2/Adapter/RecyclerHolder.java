...
import com.wtm.testdagger2.BitmapUtil;
...
public class RecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerHolder setText(int viewId, Spanned text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        return this;
    }

    public RecyclerHolder setTextLeftDrawable(int viewId, @DrawableRes int id, String text, @ColorRes int colorId) {
        TextView tv = getView(viewId);
        BitmapUtil.setLeftDrawable(mContext, id, tv, text, colorId);
        return this;
    }

    public RecyclerHolder setItemDrawable(int viewId, String text, @DrawableRes int id) {
        TextView tv = getView(viewId);
        BitmapUtil.setItemDrawable(mContext, id, tv, text, null);
        return this;
    }
    ...
    public RecyclerHolder setVisible1(int viewId, boolean visible) {
        View view = getView(viewId);
        view.setVisibility(visible ? View.VISIBLE : View.GONE);
        return this;
    }
